...
// Задача: cоздайте кнопку, которая будет скрывать 
// и показывать текст в заголовке 
// <h1>
//
// Инструкция:
...
// Как должно работать: нажатие на кнопку «Скрыть»
// скрывает текст заголовка. Повторное нажатие показывает текст снова.
 const text = document.querySelector('.title');
const bt = document.querySelector('.toggle-btn');
 
//  добавляе дествие на кнопку скрыть
bt.addEventListener('click', () => {
    // идет проверка на то скрыт ли сейчас заголовок 
    if(text.hidden){
        text.hidden = false; //показываем заголовок
        bt.textContent = 'Скрыть текст!'; // меняем текст на кнопке
    }
    else {
        text.hidden = true; //скрываем заголовок
        bt.textContent = 'Показать текст!'; // меняем текст на кнопке
...
const bt2 = document.querySelector('.toggle-bt2');
...
// Как должно работать: нажатие на кнопку «Изменить текст» 
// меняет текст заголовка на «Привет, мир!».
const bt3 = document.querySelector('.toggle-btn3');
...
const description2 = document.querySelectorAll('.description');

description2.forEach(text =>{
...
const buttonClick = document.querySelector('.addBtn')
...
// Как должно работать: нажатие на кнопку «Удалить элемент» 
// удаляет первый абзац с классом 
// description
//  со страницы.
